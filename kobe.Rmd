...
legend(1, 0.37, legend=c("accuracy", "precision", "recall"), col=c("red", "blue", "green"), lty=1:2, cex=0.8, box.lty=0)
```

In an evaluation context it can be useful to consider not only 
